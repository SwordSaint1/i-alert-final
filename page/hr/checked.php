        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
           ...
           <div class="col-sm-6">
              <div class="row">
                    <div class="col-6">
                <label for="">Audited Date From:</label> <input type="date" id="hrauditedlistcheckeddatefrom" class="form-control" value="<?=$server_month;?>" autocomplete=off>
                    </div>
                    <div class="col-6">
                <label for="">Audited Date To:</label>  <input type="date" id="hrauditedlistcheckeddateto" class="form-control" value="<?=$server_date_only;?>" autocomplete=off> 
                  </div>
          </div>
          <!-- /.col -->
        </div><!-- /.row -->
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 100px;">
                    <button class="btn btn-primary" id="searchReqBtn" onclick="load_list_of_audited_findings_hr_checked()">Search <i class="fas fa-search"></i></button> 
              ...
              <tr>
                <th>
                 ...
                 <button class="btn btn-secondary" onclick="uncheck_all()">Uncheck</button>
                    ...
                    <div class="col-6">
               <button class="btn btn-success " onclick="export_audited_list_hr_checked('audited_list_data_hr_checked')">Export</button>
